"""
Django settings for Tienda_Kova project.
...
WSGI_APPLICATION = 'Tienda_Kova.wsgi.application'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.auth.context_processors.auth',
                'django.contrib.messages.context_processors.messages',
                'Tienda.context_processors.categorias_disponibles',  # Agrega esto
            ],
        },
    },
]
